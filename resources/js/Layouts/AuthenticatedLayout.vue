...
<template>
    <div>
        <div class="min-h-screen mx-[8%] mt-4">
            <div class="grid grid-cols-4">
                <div class="sidebar col-span-1 pt-6">
                    test
                </div>
                                    ...
                                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                        <div class="flex justify-between h-16">
                                            <div class="flex">
                                                ...
                                                <span
                                                    class="text-[1.4rem] text-gray-700 text-opacity-90 font-large tracking-tight hover:text-cool-gray-600 transition duration-150 ease-in-out">Products</span>
                                                    </NavLink>
                                                </div>
                                                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                                    <NavLink :href="route('client.index')"
                                                             :active="route().current('client.index')">
                                                <span
                                                    class="text-[1.4rem] text-gray-700 text-opacity-90 font-large tracking-tight hover:text-cool-gray-600 transition duration-150 ease-in-out">Users</span>
                                                    </NavLink>
                                                </div>
                                                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                                ...
                                                <span
                                                    class="text-[1.4rem] text-gray-700 text-opacity-90 font-large tracking-tight hover:text-cool-gray-600 transition duration-150 ease-in-out">Orders</span>
                                                    </NavLink>
                                                </div>
                                            </div>
                                            ...
                                            <div class="hidden sm:flex sm:items-center sm:ms-6">
                                                ...
                                                <div class="ms-3 relative">
                                                    ...
                                                    <span class="inline-flex rounded-md">
                                                        ...
                                                        <template #content>
                                                            <DropdownLink :href="route('profile.edit')"> Profile
                                                            </DropdownLink>
