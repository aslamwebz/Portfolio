            ...
            <div class="space-y-6 border-l-2 border-dashed">
                <div class="relative w-full">
                    ...
                    <div class="ml-6">
                        ...
                        <p class="mt-2 max-w-screen-sm text-sm text-gray-500">Maecenas finibus nec sem ut imperdiet. Ut
                            tincidunt est ac dolor aliquam sodales. Phasellus sed mauris hendrerit, laoreet sem in,
                            lobortis ante.</p>
                ...
                <div class="relative w-full">
                    ...
                    <div class="ml-6">
                        ...
                        <p class="mt-2 max-w-screen-sm text-sm text-gray-500">Aliquam tincidunt malesuada tortor vitae
                            iaculis. In eu turpis iaculis, feugiat risus quis, aliquet urna. Quisque fringilla mollis
