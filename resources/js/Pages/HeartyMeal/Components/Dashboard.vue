        ...
        <div v-else class="container px-4 mx-auto my-8">
            ...
            <div class="flex justify-center gap-6 mb-12">
                <button @click="scrollLeft"
                    class="p-2 my-auto text-white bg-orange-500 rounded-full hover:bg-orange-600">
                ...
                <div class="flex gap-4 overflow-auto scroll-container" ref="scrollContainer">
                    <button v-for="category in categories" :key="category.id"
                        @click="filterRestaurantsByCategory(category.slug)" :class="['flex flex-col items-center gap-2 border p-3 rounded-lg min-w-28 hover:border-primary hover:bg-orange-100 cursor-pointer group overflow-hidden',
                            selectedCategory === category.slug ? 'border-orange-500 bg-orange-100' : '']">
                        <img :src="category.icon" class="transition-all duration-200 group-hover:scale-125"
                            :alt="category.name" height="100" width="100">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="relative overflow-hidden">
                    <img :src="`img/HeartyMeal/Restaurents/${restaurant.image}`" :alt="restaurant.name" @error="handleImageError"
                        class="object-cover w-full h-48 transition-transform duration-200 transform-gpu group-hover:scale-105">
                    <div
                        class="absolute top-4 right-4 px-3 py-1.5 text-sm font-semibold bg-white/90 backdrop-blur-sm rounded-lg shadow">
                ...
                <div class="p-5">
                    <div class="flex items-start justify-between mb-3">
                        ...
                        <div class="flex items-center gap-1 px-2.5 py-1.5 bg-green-100 rounded-lg">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-green-700" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path
            ...
            <div class="flex items-center justify-between px-6 py-10 mt-12 border-t">
                ...
                <div class="flex items-center gap-2">
                    <button @click="previousPage" :disabled="currentPage === 1" :class="['px-4 py-2 text-sm font-medium rounded-md',
                        currentPage === 1
                    ...
                    <div class="flex items-center gap-2">
                        <button v-for="page in displayedPages" :key="page" @click="goToPage(page)" :class="['px-4 py-2 text-sm font-medium rounded-md',
                            currentPage === page
                    ...
                    <button @click="nextPage" :disabled="currentPage === totalPages" :class="['px-4 py-2 text-sm font-medium rounded-md',
